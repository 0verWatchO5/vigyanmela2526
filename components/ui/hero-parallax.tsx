...
export const Header = () => {
  return (
    <div className="max-w-10xl relative mx-auto py-20 md:py-40 px-4 w-full  left-0 top-[-140] md:pl-20">
      <h1 className="text-1xl md:text-5xl font-bold dark:text-white">
